##################################################
# ScheduleExpertService_services_server.py
#      Generated by ZSI.generate.wsdl2dispatch.ServiceModuleWriter
#
##################################################

from ScheduleExpertService_services import *
from ZSI.ServiceContainer import ServiceSOAPBinding

class ScheduleExpertService(ServiceSOAPBinding):
    soapAction = {}
    root = {}
    _wsdl = """<?xml version=\"1.0\" ?>
<wsdl:definitions name=\"ScheduleExpertService\" targetNamespace=\"http://soap116.signetcs.com\" xmlns:ns1=\"http://schemas.xmlsoap.org/wsdl/soap/http\" xmlns:soap=\"http://schemas.xmlsoap.org/wsdl/soap/\" xmlns:tns=\"http://soap116.signetcs.com\" xmlns:wsdl=\"http://schemas.xmlsoap.org/wsdl/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\">
  <wsdl:types>
<xs:schema attributeFormDefault=\"unqualified\" elementFormDefault=\"unqualified\" targetNamespace=\"http://soap116.signetcs.com\" xmlns:tns=\"http://soap116.signetcs.com\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\">
  ...
  <wsdl:service name=\"ScheduleExpertService\">
    ...
    def __init__(self, post='/ScheduleExpertService/services/ScheduleExpertService', **kw):
        ServiceSOAPBinding.__init__(self, post)

    def soap_scheduleExpertForTestimony(self, ps):
        self.request = ps.Parse(scheduleExpertForTestimony.typecode)
        return scheduleExpertForTestimonyResponse()

    soapAction[''] = 'soap_scheduleExpertForTestimony'
    root[(scheduleExpertForTestimony.typecode.nspname,scheduleExpertForTestimony.typecode.pname)] = 'soap_scheduleExpertForTestimony'

    def soap_cancelExpertForTestimony(self, ps):
        self.request = ps.Parse(cancelExpertForTestimony.typecode)
        return cancelExpertForTestimonyResponse()

    soapAction[''] = 'soap_cancelExpertForTestimony'
    root[(cancelExpertForTestimony.typecode.nspname,cancelExpertForTestimony.typecode.pname)] = 'soap_cancelExpertForTestimony'
